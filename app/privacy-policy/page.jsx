  ...
  <Layout>
    <div className="container py-5 my-5">
      <div className="page-content">
        ...
        <p>
          <strong>Pacesetter Frontier Magazine</strong> (“us”, “we”, or
          “our”) operates <strong>https://pacesetterfrontier.com</strong>{" "}
          (hereinafter referred to as <strong>“Service”</strong>).
        </p>
        <p>
          Our Privacy Policy governs your visit to{" "}
          <strong>https://pacesetterfrontier.com</strong>, and explains how we
        ...
        <p>
          <strong>SERVICE</strong> means the https://pacesetterfrontier.com
          website operated by Pacesetter Frontier Magazine.
        </p>
        <p>
        ...
        <p>
          Pacesetter Frontier Magazine uses the collected data for various
          purposes:
        </p>
        ...
        <p>
          Pacesetter Frontier Magazine will take all the steps reasonably
        ...
        <p>
          ...
          us at <strong>thepacesetter03@gmail.com</strong>.
        </p>
        ...
        <p>
          ...
          by email: <strong>thepacesetter03@gmail.com</strong>.
        </p>
